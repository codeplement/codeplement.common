...
export abstract class HttpService {
    ...
    protected put<T>(
        ...
        return this.http.put<T>(this.baseUrl + path,
            body,
            this.httpOptions
                .addParams(...params)
                .getOptions()
    ...
    protected post<T>(
        ...
        return this.http.post<T>(this.baseUrl + path,
            body,
            this.httpOptions
                .addParams(...params)
                .getOptions()
    ...
    protected head<T>(
        ...
        return this.http.head<T>(this.baseUrl + path,
            this.httpOptions
                .addParams(...params)
                .getOptions()
        ).pipe(
    ...
    protected options<T>(
        ...
        return this.http.options<T>(this.baseUrl + path,
            this.httpOptions
                .addParams(...params)
                .getOptions()
        ).pipe(
